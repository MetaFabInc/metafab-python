...
class ContractsApi(object):
    ...
    def transfer_contract_ownership(
        ...
        **kwargs
        ...
        >>> thread = api.transfer_contract_ownership(contract_id, x_authorization, x_password, transfer_contract_ownership_request, async_req=True)
        >>> result = thread.get()
    ...
    def upgrade_contract_trusted_forwarder(
        ...
        **kwargs
        ...
        >>> thread = api.upgrade_contract_trusted_forwarder(contract_id, x_authorization, x_password, upgrade_contract_trusted_forwarder_request, async_req=True)
        >>> result = thread.get()
