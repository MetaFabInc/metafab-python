...
class ShopOffer(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ShopOffer - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (int): The id of this offer.. [optional]  # noqa: E501
            input_collection (str): The address of the ERC1155 or MetaFab game items contract for input items required by this offer.. [optional]  # noqa: E501
            input_collection_item_ids ([int]): An array of item ids from the input collection that are required for this offer.. [optional]  # noqa: E501
            input_collection_item_amounts ([int]): An array of amounts for each item id for the input collection that are required to use this offer.. [optional]  # noqa: E501
            ...
            output_collection (str): The address of the ERC1155 or MetaFab game items contract for output items given by this offer.. [optional]  # noqa: E501
            output_collection_item_ids ([int]): An array of item ids from the output collection that are given for this offer.. [optional]  # noqa: E501
            output_collection_item_amounts ([int]): An array of amounts for each item id for the output collection that are given by this offer.. [optional]  # noqa: E501
            ...
            uses (int): The number of times this offer has been used.. [optional]  # noqa: E501
            max_uses (int): The maximum number of times this offer can be used. A value of `0` means there is no limit on how many times this offer can be used.. [optional]  # noqa: E501
